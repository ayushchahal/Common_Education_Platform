		...
		try {
			...
			if(loginType == 2)
			{
				...
				else
				{
					...
					String batches="<a href=\"/ViewBatches\">Batches</a>";
					...
					out.print(html+head+bootstrapCDN+closeHead+body+header+cardBodyStart+cardBodyTitle+br+addStudent+br+viewStudentDetails+br+addTeacher+br+viewTeacher+br+createTest+br+viewTests+br+batches+cardBodyEnd+cardEnd+closeBody+closeHtml);
				}
			}
			else
			{
