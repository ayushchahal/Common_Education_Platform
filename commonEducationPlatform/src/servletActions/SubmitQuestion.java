	...
	public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try {
			...
			else 
			{
				...
				if(buttonAction != null)
				{
					if(buttonAction.equalsIgnoreCase("To Next Question"))
					{
						...
						if(timeLimitTypeID.equals("1"))
						{
							...
							int nextUnAnsweredQuestionNumber = tc.getNextUnAnsweredQuestionNumber(qno, testID, studentID, questionIDs);
							request.setAttribute("questionNumber", nextUnAnsweredQuestionNumber);	
					...
					else if(buttonAction.equalsIgnoreCase("To Previous Question"))
					{
						if(timeLimitTypeID.equals("1"))
						{
							...
							int previousUnAnsweredQuestionNumber = tc.getPreviousUnAnsweredQuestionNumber(qno, testID, studentID, questionIDs);
							request.setAttribute("questionNumber", previousUnAnsweredQuestionNumber);	
				...
				{
					String action = request.getParameter("pallete");
					request.setAttribute("questionNumber", action);
					if(tc.isQuestionAlreadyAnswered(studentID, questionID))
					{
						String answer2 = tc.getAnswer(studentID, questionID);
						request.setAttribute("answer", answer2);
