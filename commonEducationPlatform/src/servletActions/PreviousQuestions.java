		...
		try {
			...
			else
			{
				if(loginType == 1 || loginType == 2)
				{
					...
					if(tc.isQuestionUpdated(""+questionID, cQuestionText, cQuestionType, cPMarks, cNMarks, options[0], options[1], options[2], options[3], options[4], options[05], answer, timeLimit))
						tc.insertQuestionDetails(cQuestionText, cQuestionType, cPMarks, cNMarks, options[0], options[1], options[2], options[3], options[4], options[5], testID,answer,timeLimit);
