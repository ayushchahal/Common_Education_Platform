		...
		try {
			...
			else 
			{
				...
				*/
				...
				String form = "<div class=\"row\"><div class=\"col-sm-9\"><form action=\"SubmitQuestion\" method=\"Post\" id=\"questionPaper\">";
				...
				*/
				...
				if(questionNumber == 1)
					out.print();
				else if(questionNumber == numberOfQuestions)
					out.print();
				else
					out.print();
