			...
			else 
			{
				...
				*/
				...
				String html = "<html><head><meta charset=\"utf-8\">\r\n" + 
						...
						+ "<script src=\"\\javascript\\"+javascript+"\"></script></head>";
				...
				*/
				...
				if(questionNumber == 1)
					out.print();
				else if(questionNumber == numberOfQuestions)
					out.print();
				else
					out.print();
