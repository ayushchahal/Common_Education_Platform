		...
		try {
			...
			else 
			{
				...
				sss = "<script\r\n" + 
						...
						"  crossorigin=\"anonymous\"></script>" + sss;
				...
				String textArea = 
						"<textarea id=\"question\" name=\"question\" style=\"width:100%\"></textarea><br>";
				...
				String form=
						"<div class=\"card-body\">"
					+	"<form action=\"SaveTest\" method=\"Post\" id=\"questionsForm\">";
				...
				String options = "<div id=\"option-1\">"+
						...
						"			</div>" + 
						"		<textarea onclick=\"clearParagraph()\" name=\"option-1\" class=\"options\" style=\"width:100%;height:100%\"></textarea>"+
						"		</div>" + 
						"	</div>"+
						"</label>" + 
						"</div>"
				+
						...
						"				</div>" + 
						"			<textarea onclick=\"clearParagraph()\" name=\"option-2\" class=\"options\" style=\"width:100%;height:100%\"></textarea>"+
						"			</div>" + 
						"		</div>"+
						"	</label>" + 
						"</div>"
				+
						...
						"				</div>" + 
						"			<textarea onclick=\"clearParagraph()\" name=\"option-3\" class=\"options\" style=\"width:100%;height:100%\"></textarea>"+
						"			</div>" + 
						"		</div>"+
						"	</label>" + 
						"</div>"
				+
						...
						"				</div>" + 
						"			<textarea onclick=\"clearParagraph()\" name=\"option-4\" class=\"options\" style=\"width:100%;height:100%\"></textarea>"+
						"			</div>" + 
						"		</div>"+
						"	</label>" + 
						"</div>";
				...
				String previousButton = "<br><br><input class=\"btn btn-primary float-left\" type=\"submit\" name=\"save\" id=\"prev\" value=\"To Previous Question\" style=\"margin-left:2%\">";
				String nextbutton="<input class=\"btn btn-primary float-right\" type=\"submit\" name=\"save\" value=\"To Next Question\" style=\"margin-left:2%\">";
						
				String saveAndExit="<input class=\"btn btn-success float-left\" type=\"submit\" name=\"save\" value=\"Save & Exit\" style=\"margin-left:2%\">";
				
				String completeQuestionSubmission="<input class=\"btn btn-success float-right\" type=\"submit\" name=\"save\" value=\"Complete Questions Submission\" style=\"margin-left:2%\">";
					...
					else if(typeOfQuestion.equals("2"))
					{
						...
						if(noOfOptionsInAQuestion == 2)
						{
							if(answer.equals("1"))
							{
								...
								"			</div>" + 
								"		<textarea onclick=\"clearParagraph()\" name=\"option-1\" class=\"options\" style=\"width:100%;height:100%\">"+
										o1 + 
								"		</textarea>"+
								"		</div>" + 
								"	</div>"+
						...
						+
								...
								"					<input type=\"radio\" name=\"options\" value=\"2\" class=\"radio\">" + 
								"				</div>" + 
								"			<textarea onclick=\"clearParagraph()\" name=\"option-2\" class=\"options\" style=\"width:100%;height:100%\">"+
											o2 +
								"			</textarea>"+
								"			</div>" + 
								"		</div>"+
						...
						+
								...
								"					<input type=\"radio\" name=\"options\" value=\"3\" class=\"radio\">" + 
								"				</div>" + 
								"			<textarea onclick=\"clearParagraph()\" name=\"option-3\" class=\"options\" style=\"width:100%;height:100%\">"+
											o3 + 
								"</textarea>"+
								"			</div>" + 
								"		</div>"+
						...
						else if(noOfOptionsInAQuestion == 4)
						{
							...
							{ 
								...
								"				<input type=\"radio\" name=\"options\" value=\"1\" class=\"radio\" checked = \"checked\">" + 
								"			</div>" + 
								"		<textarea onclick=\"clearParagraph()\" name=\"option-1\" class=\"options\" style=\"width:100%;height:100%\">"+o1+"</textarea>"+
								"		</div>" + 
								"	</div>"+
								"</label>" + 
								"</div>"
						+
								...
								"					<input type=\"radio\" name=\"options\" value=\"2\" class=\"radio\">" + 
								"				</div>" + 
								"			<textarea onclick=\"clearParagraph()\" name=\"option-2\" class=\"options\" style=\"width:100%;height:100%\">"+o2+"</textarea>"+
								"			</div>" + 
								"		</div>"+
								"	</label>" + 
								"</div>"
						+
								...
								"					<input type=\"radio\" name=\"options\" value=\"3\" class=\"radio\">" + 
								"				</div>" + 
								"			<textarea onclick=\"clearParagraph()\" name=\"option-3\" class=\"options\" style=\"width:100%;height:100%\">"+o3+"</textarea>"+
								"			</div>" + 
								"		</div>"+
								"	</label>" + 
								"</div>"
						+
								...
								"					<input type=\"radio\" name=\"options\" value=\"4\" class=\"radio\">" + 
								"				</div>" + 
								"			<textarea onclick=\"clearParagraph()\" name=\"option-4\" class=\"options\" style=\"width:100%;height:100%\">"+o4+"</textarea>"+
								"			</div>" + 
								"		</div>"+
								"	</label>" + 
								"</div>";
						...
						else if(noOfOptionsInAQuestion == 5)
						{
							if(answer.equals("1"))
							{
								...
								+
										...
										"				</div>" + 
										"			<textarea onclick=\"clearParagraph()\" name=\"option-5\" class=\"options\" style=\"width:100%;height:100%\">"+o5+"</textarea>"+
										"			</div>" + 
										"		</div>"+
										"	</label>" + 
										"</div>";
						...
						else if(noOfOptionsInAQuestion == 6)
						{
							if(answer.equals("1"))
							{
								...
								+
										...
										"				</div>" + 
										"			<textarea onclick=\"clearParagraph()\" name=\"option-6\" class=\"options\" style=\"width:100%;height:100%\">"+o6+"</textarea>"+
										"			</div>" + 
										"		</div>"+
										"	</label>" + 
										"</div>";
