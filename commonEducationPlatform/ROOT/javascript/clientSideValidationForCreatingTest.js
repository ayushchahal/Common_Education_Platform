function clientSideValidations()
{
	...
	document.getElementById('validationTimeLimit').setAttribute('style','display:none');
	document.getElementById('validationTimeLimit').setAttribute('style','display:none');
	...
	if(time == "" || time == null)
	{
		document.getElementById('validationTimeLimit').setAttribute('style','display:block');
	...
	{
		document.getElementById('validationTimeLimit').setAttribute('style','display:block');
		document.getElementById('limitValidation').setAttribute('style','display:none');
		document.getElementById('impracticalTimeLimit').setAttribute('style','display:block;color:red');
		document.getElementById('timeLimit').focus();
		counter = 1;
	}
